def paradicsomleves (sajt,kenyer):
    ...
    print('Szórj rá reszelt ' + sajt + ' -t.')
    print('Szolgáld fel '+ kenyer + '-val/vel')

#paradicsomleves('trapista', 'kenyér')
paradicsomleves('kenyér', 'trapista')